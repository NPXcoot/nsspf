				...
				for dx = -2,2 do
					for dy = -2,1 do
						for dz = -2,2 do
							local pos1 = {x=pos.x+dx, y=pos.y+dy, z=pos.z+dz}
							local n = minetest.get_node(pos1).name
							if n == "nsspf:tuber_magnatum_pico_tuber_mycelium" or n == "nsspf:tuber_melanosporum_tuber_mycelium" or n == "nsspf:tuber_borchii_tuber_mycelium" or n == "nsspf:terfezia_arenaria_tuber_mycelium" then
								return
							end
						end
					end
...
nsspf_register_tuber ("tuber_magnatum_pico","Tuber magnatum pico","default:tree", 30, 30, 20, 20)
nsspf_register_tuber ("tuber_melanosporum","Tuber melanosporum","default:pine_tree", 18, 18, 16, 16)
nsspf_register_tuber ("tuber_borchii","Tuber borchii","default:aspen_tree", 12, 12, 12, 14)
nsspf_register_tuber ("terfezia_arenaria","Terfezia arenaria","default:acacia_tree", 10, 10, 12, 20)
